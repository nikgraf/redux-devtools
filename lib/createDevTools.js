...
function createDevTools(React) {
  ...
  var DevTools = (function (_Component) {
    ...
    DevTools.prototype.componentWillMount = function componentWillMount() {
      var monitorState = _extends({}, this.props.monitorState, {
    ...
    DevTools.prototype.render = function render() {
      ...
      return React.createElement(Monitor, _extends({}, this.props, { monitorState: monitorState }));
    };
